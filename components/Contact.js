    ...
    <section id="contact" className="py-24 bg-dark-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          {/* Left */}
          <div>
            <span className="text-gold-500 font-bold text-xs uppercase tracking-[0.3em] mb-4 block">
              Get In Touch
            </span>
            <h2 className="text-4xl sm:text-5xl font-black text-white leading-tight mb-6">
              Start Your
              <br />
              <span className="text-gold-500">Free Trial Today.</span>
            </h2>
            <p className="text-gray-400 text-lg leading-relaxed mb-10">
              Walk in for a free trial session. No commitment, no payment — just
              come experience AVS Fitness for yourself.
            </p>
            ...
            <div className="space-y-5">
              {[
                [
                  "📍",
                  "Location",
                  "AVS Fitness, warje Road, warje, Pune – 411005",
                ],
                ["📞", "Phone", "+91 7719988860"],
