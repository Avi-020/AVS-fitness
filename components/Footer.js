      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-9 h-9 bg-gold-500 rounded-lg flex items-center justify-center font-black text-dark-900 text-sm">
                AVS
              </div>
              <div>
                ...
                <div className="text-gold-500 text-[10px] font-semibold tracking-[0.2em] uppercase">
                  Pune
                </div>
              </div>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed mb-5 max-w-xs">
              Pune&apos;s premium fitness destination. 12,000 sq.ft of
              world-class training space.
            </p>
            <div className="text-xs text-gray-600">
              <div>📍 warje Road, warje, Pune</div>
              <div className="mt-1">📞 +91 7719988860</div>
            </div>
          </div>
        ...
        <div className="bg-gold-500/5 border border-gold-500/20 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 mb-12">
          <div>
            ...
            <div className="text-gray-400 text-sm">
              Walk in today for your free trial session.
            </div>
          </div>
          <Link
            href="#contact"
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-gray-600 text-xs">
            © 2024 AVS Fitness Pvt. Ltd. All rights reserved. | Pune,
            Maharashtra
          </p>
